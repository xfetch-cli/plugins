...
<ol>
  ...
  <li>Workspace target directory of the plugins repository: <code>target/release/</code>.</li>
...
<p>
  The <a href="../plugins/animate-logo/"><code>animate-logo</code></a> plugin is the reference
...
<ol>
  ...
  <li>Add an entry for your plugin in <a href="../README.md">README.md</a>.</li>
